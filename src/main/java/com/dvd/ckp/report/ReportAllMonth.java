 ...
 * @author dmin
 */
public class ReportAllMonth extends GenericForwardComposer {

    private static final Logger logger = Logger.getLogger(ReportAllMonth.class);
    ...
    private String reportName = "all_month.rptdesign";
    private String fileName = "Bao_Cao_Cac_Thang";
    ...
    private boolean validateParam() {
        ...
        if (dteFromDate.getValue() == null) {
            Clients.showNotification(Labels.getLabel("month.empty"), Clients.NOTIFICATION_TYPE_ERROR, dteFromDate, Constants.MESSAGE_POSTION_END_CENTER, Constants.MESSAGE_TIME_CLOSE, Boolean.TRUE);
