 ...
 * @author dmin
 */
public class ReportDay extends GenericForwardComposer {

    private static final Logger logger = Logger.getLogger(ReportDay.class);
    ...
    private String reportName = "report_day.rptdesign";
    private String fileName = "Bao_Cao_Ngay";
